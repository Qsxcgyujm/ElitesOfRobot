...
from ElitesOfRobot.modules.helper_funcs.admin_rights import user_can_ban
from ElitesOfRobot.modules.helper_funcs.readable_time import get_readable_time

from ElitesOfRobot import (dispatcher, since_time_start, updater, TOKEN, OWNER_ID, WEBHOOK,
                           CERT_PATH, PORT, URL, LOGGER, BLACKLIST_CHATS, WHITELIST_CHATS,
                           SUPPORT_CHAT, START_IMG, REPOSITORY)

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from ElitesOfRobot.modules import ALL_MODULES
from ElitesOfRobot.modules.purge import client
from ElitesOfRobot.modules.helper_funcs.chat_status import is_user_admin
from ElitesOfRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ElitesOfRobot.modules." + module_name)
...
@run_async
def ElitesOfRobot_about_callback(update, context):
    query = update.callback_query
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(ElitesOfRobot_about_callback, pattern=r"aboutmanu_")
