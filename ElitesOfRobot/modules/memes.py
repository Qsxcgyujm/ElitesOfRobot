...
from ElitesOfRobot.modules.helper_funcs.extraction import extract_user
...
from ElitesOfRobot import dispatcher, SUDO_USERS, SUPPORT_USERS, LOGGER
from ElitesOfRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler

import ElitesOfRobot.modules.helper_funcs.fun_strings as fun

#truth / dare - by alluka(@zoldycktmbot)
@run_async
@typing_action
