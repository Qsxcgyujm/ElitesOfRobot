...
import ElitesOfRobot.modules.sql.global_mutes_sql as sql
from ElitesOfRobot import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, STRICT_GMUTE, ERROR_DUMP
...
def __user_book__(user_id):
    ...
    if int(user_id) in SUDO_USERS + DEV_USERS + SUPPORT_USERS + WHITELIST_USERS:
        text = text.format("❓")
        return text
