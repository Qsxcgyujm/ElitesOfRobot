...
if is_module_loaded(FILENAME):
    ...
    from ElitesOfRobot import dispatcher, LOGGER, MESSAGE_DUMP
    from ElitesOfRobot.modules.helper_funcs.chat_status import user_admin
    from ElitesOfRobot.modules.sql import log_channel_sql as sql
    ...
    def __stats__():
        return "┣⊸ Log Channels - {}".format(sql.num_logchannels())
