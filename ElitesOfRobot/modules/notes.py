...
from ElitesOfRobot import dispatcher, MESSAGE_DUMP, LOGGER
from ElitesOfRobot.modules.disable import DisableAbleCommandHandler
from ElitesOfRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from ElitesOfRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from ElitesOfRobot.modules.helper_funcs.msg_types import get_note_type
from ElitesOfRobot.modules.helper_funcs.string_handling import (
...
def __stats__():
    return "┣⊸ Notes - {} ( {} ) ".format(sql.num_notes(), sql.num_chats())
...
CLEARALLNOTES_HANDLER = CommandHandler("clearall", clear_notes, filters=Filters.group)
