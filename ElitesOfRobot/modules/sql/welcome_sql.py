...
from ElitesOfRobot.modules.helper_funcs.msg_types import Types
from ElitesOfRobot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Welcome {first}, Avoid Kicks if you can!",
    ...
    "Huh?\nDid someone with a staff member just join?\nOh wait, it's just {first}.",  #One Punch ma 
    ...
    "Hola {first}, beware of people with staff members",
