...
import ElitesOfRobot.modules.sql.notes_sql as sql
from ElitesOfRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ElitesOfRobot.__main__ import DATA_IMPORT
from ElitesOfRobot.modules.helper_funcs.chat_status import user_admin
from ElitesOfRobot.modules.helper_funcs.alternate import typing_action

# from ElitesOfRobot.modules.rules import get_rules
import ElitesOfRobot.modules.sql.rules_sql as rulessql

# from ElitesOfRobot.modules.sql import warns_sql as warnssql
import ElitesOfRobot.modules.sql.blacklist_sql as blacklistsql
from ElitesOfRobot.modules.sql import disable_sql as disabledsql

# from ElitesOfRobot.modules.sql import cust_filters_sql as filtersql
# import ElitesOfRobot.modules.sql.welcome_sql as welcsql
import ElitesOfRobot.modules.sql.locks_sql as locksql
from ElitesOfRobot.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                f"An error occurred while recovering your data. The process failed. If you experience a problem with this, please ask @{SUPPORT_CHAT}"
            )
