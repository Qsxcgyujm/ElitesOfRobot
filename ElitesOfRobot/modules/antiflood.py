...
from ElitesOfRobot import dispatcher, REDIS, SUDO_USERS
from ElitesOfRobot.modules.helper_funcs.chat_status import is_user_admin, user_admin
...
from ElitesOfRobot.modules.sql import antiflood_sql as sql
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        send_message(
            ...
            "Great, I like to leave flooding to staff members but you, "
