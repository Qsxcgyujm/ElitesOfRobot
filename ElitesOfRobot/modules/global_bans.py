...
from ElitesOfRobot.modules.helper_funcs.chat_status import user_admin, is_user_admin, support_plus
from ElitesOfRobot.modules.helper_funcs.extraction import extract_user, extract_user_and_text, get_user
...
from ElitesOfRobot import client
from telethon import events

from html_telegraph_poster import TelegraphPoster
from html_telegraph_poster.upload_images import upload_image

Chizuru_Gban = TelegraphPoster(use_api=True)
Chizuru_Gban.create_api_token('Chizuru Gban', 'Chizuru') 
...
def gban(update, context):
    ...
    page = Chizuru_Gban.post(title=f"Chizuru-Gban-{user_chat.id}", author=f"{banner.first_name} ({banner.id})", text=EVIDENSE_NEW_GBAN)
    evidence_link = page.get('url')
    evidence_link = "<a href='{}'>{}</a>".format(evidence_link, f"Chizuru Evidence")
