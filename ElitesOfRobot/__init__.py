...
if ENV:
    ...
    LEAVE_MSG = os.environ.get('LEAVE_MSG', "GOODBYE")
    LEAVE_STICKER = os.environ.get('LEAVE_STICKER',
...
client = TelegramClient("elitesofrobot", API_ID, API_HASH)
...
from ElitesOfRobot.modules.helper_funcs.handlers import CustomCommandHandler
